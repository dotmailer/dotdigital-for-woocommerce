...
/**
 * Class Dotdigital_WooCommerce_Rest_Api
 */
class Dotdigital_WooCommerce_Rest_Api {
	...
	/**
	 * Dotdigital_WooCommerce_Rest_Api constructor.
	 *
	...
	public function register_routes() {
		register_rest_route(
			...
			array(
				...
				'callback' => array( new Dotdigital_WooCommerce_Rest_Configurations( $this->plugin_name ), 'set_configurations' ),
	 ...
	 */
	protected function dd_rest_response( $data, $status = 200 ) {
		if ( ! is_array( $data ) ) {
			$data = array();
		}
